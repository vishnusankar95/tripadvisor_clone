...
import searchimg from "../../images/navbar/searchimg.webp"
export const Landing = () => {
    ...
    <div className={styles.main} >
          ...
          <div className={styles.itemList}>
                ...
                <div className={styles.itemfit}>
                 <a class="astyler" href="/Hotels">

                    <span class="fZvbu o W">
                        <span class="namespan">Hotels</span>
                    </span>

                    <span class="BUNXj H0">
                        <svg viewBox="0 0 24 24" width="24px" height="24px" class="fecdL d Vb wQMPa">
                ...
                <div className={styles.itemfit}>
                <a class="astyler" href="/Rentals">

                    <span class="fZvbu o W">
                        <span class="namespan">Vacation Rentals</span>
                    </span>
                ...
                <div className={styles.itemfit}>
                <a class="astyler" href="/Attractions">
                    <span class="fZvbu o W">
                        <span class="namespan">Things to Do</span>
                    </span>
                    
                    <span class="BUNXj H0">
                        <svg x="0" y="0" viewBox="0 0 24 24" width="24px" height="24px" class="fecdL d Vb wQMPa">
                ...
                <div className={styles.itemfit}>
                <a class="astyler" href="/Restaurants">
                    <span class="fZvbu o W">
                        <span class="namespan">Restaurants</span>
                    </span>
                ...
                <div className={styles.itemfit}>
                <a class="astyler" href="/ForumHome">
                    <span class="fZvbu o W">
                        <span class="namespan">Travel Forums</span>
                    </span>
                ...
                <div className={styles.itemfit}>
                <a class="astyler" type="a" aria-haspopup="menu" aria-label="Explore Tripadvisor: More">
                    <span class="fZvbu o W">
                        <span class="namespan">More</span>
                    </span>
                 
                    <span class="BUNXj H0">
                        <svg x="0" y="0" viewBox="0 0 24 24" width="24px" height="24px" class="fecdL d Vb wQMPa">
                            <circle cx="4.5" cy="11.9" r="2.5"></circle><circle cx="19.5" cy="11.9" r="2.5"></circle>
          ...
          <div className={styles.serachcontainer}>
              ...
              <input className={styles.boxerinput} type="text" placeholder="Where to?" />
          </div>
        </div>
        <Destination/>
